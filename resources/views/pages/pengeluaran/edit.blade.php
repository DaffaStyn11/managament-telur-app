<div x-data="{
    ...
    editData: {
        ...
        jumlah: {{ old('jumlah', 0) }},
        harga_satuan: {{ old('harga_satuan', 0) }},
        catatan: '{{ old('catatan', '') }}'
    },
    openEditModal(pengeluaran) {
        this.editData = pengeluaran;
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div class="relative inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl"
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Edit Pengeluaran</h3>
                    <p class="text-sm text-gray-600 mt-1">Perbarui data pengeluaran</p>
                </div>
            ...
            <!-- Modal Body -->
            <form :action="`{{ route('pengeluaran.index') }}/${editData.id}`" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Nama Barang -->
                    <div class="mb-4">
                        <label for="edit_nama_barang" class="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <!-- Kategori -->
                    <div class="mb-4">
                        <label for="edit_kategori" class="block text-sm font-semibold text-gray-700 mb-2">
                            Kategori (Opsional)
                        </label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                            ...
                            <input type="text" id="edit_kategori" name="kategori" x-model="editData.kategori"
                                class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
                                          @error('kategori') border-red-500 @enderror"
                                placeholder="Contoh: Pakan, Vitamin, dll">
                        </div>
                        @error('kategori')
                            <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                <i data-feather="alert-circle" class="w-4 h-4"></i>
                    ...
                    <!-- Jumlah -->
                    <div class="mb-4">
                        <label for="edit_jumlah" class="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="edit_jumlah" name="jumlah" x-model="editData.jumlah"
                                min="1"
                                class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
                    ...
                    <div class="mb-4 md:col-span-2">
                        <label for="edit_harga_satuan" class="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="edit_harga_satuan" name="harga_satuan"
                                x-model="editData.harga_satuan" min="0" step="0.01"
                                class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
                ...
                <div class="mb-4 p-4 bg-gray-50 rounded-xl">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-2xl font-bold text-gray-900"
                            x-text="'Rp ' + (editData.jumlah * editData.harga_satuan).toLocaleString('id-ID')"></span>
                    </div>
                </div>
