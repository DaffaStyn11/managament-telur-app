    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div class="relative inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl"
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Tambah Pengeluaran</h3>
                    <p class="text-sm text-gray-600 mt-1">Catat pengeluaran operasional peternakan</p>
                </div>
            ...
            <!-- Modal Body -->
            <form action="{{ route('pengeluaran.store') }}" method="POST" class="p-6" x-data="{ jumlah: 0, harga: 0 }">
                @csrf
