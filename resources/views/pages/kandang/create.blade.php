    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div class="relative inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl"
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Tambah Kandang Baru</h3>
                    <p class="text-sm text-gray-600 mt-1">Lengkapi form di bawah untuk menambahkan kandang</p>
                </div>
            ...
            <!-- Modal Body -->
            <form action="{{ route('kandang.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="nama_kandang" name="nama_kandang" value="{{ old('nama_kandang') }}"
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="blok" name="blok" value="{{ old('blok') }}"
                            class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="jumlah_ayam" name="jumlah_ayam" value="{{ old('jumlah_ayam') }}"
                            min="0"
                            class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
                ...
                <!-- Jenis Ayam -->
                <div class="mb-6">
                    <label for="jenis_ayam" class="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="jenis_ayam" name="jenis_ayam" value="{{ old('jenis_ayam') }}"
                            class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
