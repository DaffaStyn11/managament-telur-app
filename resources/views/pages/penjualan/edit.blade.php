<div x-data="{
    ...
    openEditModal(penjualan) {
        this.editData = penjualan;
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div class="relative inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl"
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Edit Penjualan</h3>
                    <p class="text-sm text-gray-600 mt-1">Perbarui data transaksi penjualan</p>
                </div>
            ...
            <!-- Modal Body -->
            <form :action="`{{ route('penjualan.index') }}/${editData.id}`" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Pelanggan -->
                    <div class="mb-4">
                        <label for="edit_pelanggan" class="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="edit_pelanggan" name="pelanggan" x-model="editData.pelanggan"
                                class="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-300 bg-white
                                          focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition
